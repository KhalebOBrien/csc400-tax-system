                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                <div class="grid grid-cols-6 gap-6">
                                    <!-- Expected funding -->
                                    <div class="col-span-6 sm:col-span-4">
                                        <x-label for="expected_funding" value="{{ __('How much funding do you expect to receive? ($)') }}" required />
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                <div class="grid grid-cols-6 gap-6">
                                    <!-- Campaign -->
                                    <div class="col-span-6 sm:col-span-4">
                                        <x-label for="campaign" value="{{ __('How did you hear?') }}" />
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                <div class="text-sm text-gray-600 mb-4">
                                    {{ __('I hereby certify that the information provided is accurate and true. I understand that my filling will be reviewed and additional information may be requested.') }}
                                </div>
                                <div class="grid grid-cols-6 gap-6">
                                    <!-- certification name -->
                                    <div class="col-span-6 sm:col-span-4">
                                ...
                                <div class="text-gray-600 text-base mt-4 border rounded p-4">
                                    ...
                                    <ul class="list-disc pl-8">
                                        ...
                                        <li>After completion, upload the confirmation certificate to your account.</li>
                                    </ul>
                                    ...
                                    <p>Contact our support team at <a href="mailto:support@domain.com" class="text-blue-600">support@domain.com</a> for assistance.</p>
