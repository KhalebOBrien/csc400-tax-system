<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('grants') }}" :active="request()->routeIs('grants')">
                        {{ __('Applications') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('all-messages') }}" :active="request()->routeIs('all-messages')">
                        {{ __('Support Messages') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role == "admin")
            <x-responsive-nav-link href="{{ route('grants') }}" :active="request()->routeIs('grants')">
                {{ __('Applications') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('all-messages') }}" :active="request()->routeIs('all-messages')">
                {{ __('Support Messages') }}
            </x-responsive-nav-link>
            ...
            <div class="flex items-center px-4">
                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="shrink-0 me-3">
                        <img class="h-10 w-10 rounded-full object-cover" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->full_name }}" />
                    </div>
                @endif
